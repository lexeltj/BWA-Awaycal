...
class BwaAwaycal_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'bwa-awaycal'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'bwa-awaycal'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'bwa-awaycal'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'bwa-awaycal'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'bwa-awaycal');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'bwa-awaycal'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'bwa-awaycal');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'bwa-awaycal'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'bwa-awaycal') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'bwa-awaycal');
            case 'false':
                return __('false', 'bwa-awaycal');

            case 'Administrator':
                return __('Administrator', 'bwa-awaycal');
            case 'Editor':
                return __('Editor', 'bwa-awaycal');
            case 'Author':
                return __('Author', 'bwa-awaycal');
            case 'Contributor':
                return __('Contributor', 'bwa-awaycal');
            case 'Subscriber':
                return __('Subscriber', 'bwa-awaycal');
            case 'Anyone':
                return __('Anyone', 'bwa-awaycal');
        }
        return $optionValue;
    }
